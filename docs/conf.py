...
extlinks = {'issue': ('https://github.com/saxix/drf-api-checker/issues/%s', 'issue #'),
...
project = u'DRF API Checker'
copyright = u'2018-2019, Stefano Apostolico'
...
# for a list of supported langua8ges.
# language = None
...
# This is the file name suffix for HTML files (e.. ".xhtml").
...
latex_documents = [
    ('index', 'drf_api_checker.tex', u'DRF API Checker Documentation',
...
man_pages = [
    ('index', 'drf_api_checker', u'DRF API Checker Documentation',
