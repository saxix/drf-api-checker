...
urlpatterns = (
    ...
    re_path(r'^master/detail/(?P<pk>.*)/', MasterRetrieveAPIView.as_view(), name='master-detail'),
    re_path(r'^master/update/(?P<pk>.*)/', MasterUpdateAPIView.as_view(), name='master-update'),
    re_path(r'^master/delete/(?P<pk>.*)/', MasterDeleteAPIView.as_view(), name='master-delete'),
